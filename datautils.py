...
DSETS = ['ettm1', 'forex', 'ettm2', 'etth1', 'etth2', 'electricity',
...
def get_dls(params):
    ...
    if params.dset == 'ettm1':
        root_path = 'D:/ĐACN/xLSTMTime-main/Datasets/ETT-small/'
    ...
    elif params.dset == 'forex':
        root_path = 'D:/ĐACN/xLSTMTime-main/Datasets/forex/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_Forex,
                dataset_kwargs={
                'root_path': root_path,
                'data_path': 'EURUSD_03_23.csv',
                'features': params.features,
                'scale': True,
                'size': size,
                'use_time_features': params.use_time_features
        ...
        root_path = 'C:/Users/Admin/Downloads/xLSTMTime-main/Datasets/electricity/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
        ...
        root_path = 'C:/Users/Admin/Downloads/xLSTMTime-main/Datasets/traffic/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_Custom,
                dataset_kwargs={
        ...
        root_path = 'C:/Users/Admin/Downloads/xLSTMTime-main/Datasets/weather/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_Custom,
                dataset_kwargs={
        ...
        root_path = 'C:/Users/Admin/Downloads/xLSTMTime-main/Datasets/illness/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_Custom,
                dataset_kwargs={
        ...
        root_path = 'C:/Users/Admin/Downloads/xLSTMTime-main/Datasets/exchange_rate/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_Custom,
                dataset_kwargs={
